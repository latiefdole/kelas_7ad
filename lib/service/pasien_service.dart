...
class PasienService {
  Future<List<Pasien>> listData() async {
    final Response response = await ApiClientKedua().get('pasien');
  ...
  Future<Pasien> simpan(Pasien pasien) async {
    ...
    final Response response = await ApiClientKedua().post('pasien', data);
  ...
  Future<Pasien> ubah(Pasien pasien, String id) async {
    var data = pasien.toJson();
    final Response response = await ApiClientKedua().put('pasien/$id', data);
    print(response);
    Pasien result = Pasien.fromJson(response.data);
    return result;
  }
  ...
  Future<Pasien> getById(String id) async {
    final Response response = await ApiClientKedua().get('pasien/$id');
    Pasien result = Pasien.fromJson(response.data);
    return result;
  }
  ...
  Future<Pasien> hapus(Pasien pasien) async {
    final Response response =
        await ApiClientKedua().delete('pasien/${pasien.id}');
    Pasien result = Pasien.fromJson(response.data);
    return result;
  }
}
